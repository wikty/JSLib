//if arg:mark is undefined, if not find mark,the chars will not be inserted
...
//           will no limit
function insertStrByMark(str,chars,mark,maxLen){
	...
	if(typeof mark !='string'){
		...
		else throw new Error('insertStrByMark arg:mark must be a string');
	}
